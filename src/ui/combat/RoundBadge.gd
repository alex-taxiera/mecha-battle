...
## "SECTOR 1 · FLOOR 5", and the fights won, in green.
...
func set_progress(p_sector: int, p_floor: int, p_wins: int) -> void:
	sector = p_sector
...
## Returns what the badge says, e.g. "SECTOR 1 · FLOOR 5  3W".
func get_text() -> String:
	return "%s  %s" % [_place_text(), _wins_text()]
